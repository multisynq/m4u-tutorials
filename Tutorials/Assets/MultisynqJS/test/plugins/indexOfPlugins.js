...
import { PlayerMovement_Mgr_Model, PlayerMovement_Mgr_View } from './PlayerMovement_Mgr'
...
export class PluginsModelRoot extends GameModelRoot {
  ...
  init(options) {
    ...
    // ######## modelInits
    this.pluginModels['PlayerMovement_Mgr_Model'] = PlayerMovement_Mgr_Model.create({})
...
export class PluginsViewRoot extends GameViewRoot {
  ...
  constructor(model) {
    ...
    // ######### viewInits
    this.pluginViews['PlayerMovement_Mgr_View'] = new PlayerMovement_Mgr_View(model.pluginModels['PlayerMovement_Mgr_Model'])
